...
def create_programming_svg() -> str:
    ...
    return '''
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 240" width="180" height="180" class="course-icon">
        <defs>
...
def show() -> None:
    """Render the main Streamlit application with course offers."""
    st.markdown("""
        <style>
        ...
        st.markdown(f'''
            <div class="course-card">
                ...
                <div class="impact-section">
                    <h3 class="impact-title">🎯 Impact</h3>
                    <p class="impact-text">
                        Participants develop advanced skills in database management, machine learning, and real-time
                        application deployment. This course focuses on practical implementations, enabling learners to 
                        create AI-driven solutions, deploy them in real-world scenarios, and integrate applications with cloud services.
                    </p>
                </div>
